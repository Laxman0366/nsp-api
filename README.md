...
- `POST /api/change-password` requires a valid Bearer token and accepts `new_password`.
- `programme_overview` stores `programme_name` directly and no longer uses programme/project foreign keys.
